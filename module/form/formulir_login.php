<h2>Form Pendaftaran Login</h2>
<hr color="#0263A0"><br>

<form action="../process/input/input_login.php" method="POST">
    ...
    <table>
        ...
        <tr>
            <td><input type="password" name="password" size="25px" maxlength="10" placeholder="ketikkan password..">
            </td>
        </tr>
